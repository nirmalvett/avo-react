...
# Paypal Tokens
PAYPAL_ID = 'AX-_BnCq40dt6ilQ0IK07AOq6UnX4ltxl7xWlSA4J86QhD03lTTLwOYrXlIHltTX8Qc3tWKoxlOkYpjA'
PAYPAL_SECRET = 'EEhqefywgzPX8t0Quc5VAnpQ673VVlb17B1AWKA-2RlUnwjFG7cE4uCJnxNrQU4OVuL5JQllT3mTsZfq'
PAYPAL_MODE = 'sandbox'
# ===================================================================================================================
...
#   HOSTNAME = branch + ".avocadocore.com"
# else:
print(">>> CONNECTING TO LOCAL MYSQL DATABASE <<<")
#SQLALCHEMY_DATABASE_URI = 'mysql+pymysql://root@localhost/app'
SQLALCHEMY_DATABASE_URI = 'mysql+pymysql://root:equ&equ&o4teesaer1K@144.217.166.2/dev'
HOSTNAME = 'localhost'
# ===================================================================================================================
