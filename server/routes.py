...
def shutdown():
    """
    Shutsdown the app given and update from Gitlab (updating done externally)
    ...
    try:
        ...
        if not request.json:
            # If the request isnt json return a 400 error
            return abort(400)
        ...
        # This is an absolutely terrible way to handle this, MUST come back and rework this at a later date
