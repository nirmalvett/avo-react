					...
					<Grid item xs={6}>
						...
						<form style={{'width': '100%'}} noValidate autoComplete="off">
							...
							<TextField margin="normal" style={style} id="registerEmail" label="UWO Email"
							           onChange={(e) => this.setState({registerEmail: e.target.value})} value={this.state.registerEmail}
							           error={this.state.registerEmail.length > 0 && !/^[a-zA-Z]{2,}\d*@uwo\.ca$/.test(this.state.registerEmail)}/>
							<br/>
							<TextField margin="normal" style={style} id="registerPassword1" label="Password" type="password" helperText="(Minimum 8 characters)"
							           onChange={(e) => this.setState({registerPassword1: e.target.value})} value={this.state.registerPassword1}
							           error={this.state.registerPassword1.length > 0 && this.state.registerPassword1.length < 8}/>
							<br/>
							<TextField margin="normal" style={style} id="registerPassword2" label="Re-Enter Password" type="password"
							           onChange={(e) => this.setState({registerPassword2: e.target.value})} value={this.state.registerPassword2}
					...
					<Grid item xs={6}>
						...
						<form style={{'width': '100%'}} noValidate autoComplete="off">
							<TextField margin="normal" style={style} id="email" label="Email"
							           onChange={(e) => this.setState({loginEmail: e.target.value})} value={this.state.loginEmail}
							...
							<TextField margin="normal" style={style} id="loginPassword" label="Password" type="password"
							           onChange={(e) => this.setState({loginPassword: e.target.value})} value={this.state.loginPassword}
