...
class ExportTools extends Component {
  ...
  displayLegend = () => {
    if (this.state.filetype === "xlsx") {
      return (
        <div style={{ display: "flex", alignSelf: "right", alignContent: "center", margin: "auto"}}>
          <span style={{ backgroundColor: "#399103", display: "inline-block", width: "20px", height: "20px" }}></span>
          <Typography style={{display: "block", padding: "5px"}}>Student in AVO and in OWL</Typography>
          <span style={{ backgroundColor: "#FFFF00", display: "inline-block", width: "20px", height: "20px" }}></span>
          <Typography style={{display: "block", padding: "5px"}}>
            Student in AVO and in OWL but has not taken AVO tests
          </Typography>
          <span style={{ backgroundColor: "#FF1A1A", display: "inline-block", width: "20px", height: "20px" }}></span>
          <Typography style={{display: "block", padding: "5px"}}>Student not in AVO</Typography>
        </div>
      );
    }
  };
