        ...
        return (
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1044.74 555.43" style={this.props.style}>
                <g id="AVO">
                    ...
                    <circle id="O" style={{fill: color2, stroke: color1, strokeWidth: '40px'}} cx="856.99" cy="264.79" r="167.75"/>
                    <path id="V" style={{fill: color1}}
                          d="M1197.12-1169.87l-58.61-.21L1004.18-884.86,865.91-1169.62H807.26l169.37,335,52.11-.13Z"
                          transform="translate(-506.6 1267.13)"/>
                </g>
                <g id="Images">
                    <path id="Green" style={{fill: green, stroke: color2, strokeWidth: '15px'}}
                          ...
                          transform="translate(-506.6 1267.13)"/>
                    <path id="Yellow" style={{fill: yellow}}
                ...
                <g id="Strip">
                    <path style={{fill: green}} d="M565.21-834.58l63.91-136.31-52.61-.75L506.6-834.79Z"
                          transform="translate(-506.6 1267.13)"/>
                    <path style={{fill: green}} d="M565.21-834.58l63.91-136.31-52.61-.75L506.6-834.79Z"
                          transform="translate(-506.6 1267.13)"/>
                </g>
