...
export default function Logo(props: LogoProps) {
    ...
    const color1 = theme ? '#fff' : '#000';
    const color2 = theme ? '#424242' : '#fff';
    const white = '#fff';

    let primary, secondary;
    if (props.color === undefined || props.color === avoGreen) {
        primary = '#399103';
        secondary = '#f8ee7b';
    } else {
        primary = props.color['500'];
        secondary = props.color['200'];
    }

    return (
        <svg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 1044.74 555.43' style={props.style}>
            <g id='AVO'>
                <path
                    id='A'
                    style={{fill: color1}}
                    d='M699.54-1119.8,837.81-835h58.65l-169.37-335-52.11.13Z'
                    transform='translate(-506.6 1267.13)'
                />
                <circle
                    id='O'
                    style={{fill: color2, stroke: color1, strokeWidth: '40px'}}
                    cx='856.99'
                    cy='264.79'
                    r='167.75'
                />
            ...
            <g id='Images'>
                <path
                    id='Green'
                    style={{fill: primary, stroke: color2, strokeWidth: '15px'}}
            ...
            <g id='Strip'>
                <path
                    style={{fill: primary}}
                    d='M565.21-834.58l63.91-136.31-52.61-.75L506.6-834.79Z'
                    transform='translate(-506.6 1267.13)'
                />
                <path
                    style={{fill: primary}}
