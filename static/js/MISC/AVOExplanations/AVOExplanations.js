...
export default class AVOExplanations extends React.Component {
  constructor(props){
    super(props);
    this.state = {} // this is the state, if any state is changed from this.setState then any components that rely on it will change
  }
  ...
  render(){
    ...
    return (
      <div className='avo-user__background' style={{width: '100%', flex: 1, display: 'flex'}}>
        Explanations: This is where things are rendered
