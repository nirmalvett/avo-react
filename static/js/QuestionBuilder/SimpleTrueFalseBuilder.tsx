...
interface SimpleTrueFalseBuilderState {
    loaded: boolean;
    questionID: number;
    questionName: string;
    ...
    loadQuestion = (index?: number) => {
        ...
        if (isTrueFalse(question)) {
            this.setState({
                ...
                questionTxtE: false,
                questionAnsr: question.config.correct_answer as TrueFalseConfigCorrectAnswer,
...
function isTrueFalse(question: Question): boolean {
    return Boolean(question.config && question.config.type && question.config.type == 'true/false');
}
